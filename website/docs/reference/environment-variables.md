...
| `NOTTE_API_KEY` | Notte cloud browser API key ([notte.cc](https://notte.cc/)) |
| `NOTTE_API_URL` | Custom Notte API endpoint for alternate or self-hosted instances (optional) |
