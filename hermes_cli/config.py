...
OPTIONAL_ENV_VARS = {
    ...
    "NOTTE_API_KEY": {
        "description": "Notte API key for cloud browser (optional - local browser works without this)",
    ...
    "NOTTE_API_URL": {
        "description": "Notte API URL for alternate or self-hosted instances (optional)",
        "prompt": "Notte API URL (leave empty for cloud)",
        "url": None,
        "password": False,
        "category": "tool",
        "advanced": True,
